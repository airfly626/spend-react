...
final class Version20260822111044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE spend_category (id INT AUTO_INCREMENT NOT NULL, category_code NVARCHAR(2) NOT NULL, category_name NVARCHAR(10) NOT NULL, delete_flag BIT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
